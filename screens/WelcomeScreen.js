...
import { StyleSheet, Text, View, TouchableOpacity, KeyboardAvoidingView, Alert,Modal} from 'react-native';
import showModal from 'react-native'
...
userLoginUp=(email,password,)=>{
        firebase.auth().CreateUserWithEmailAndPassword(email,password)
        .then(()=>{
            this.props.navigation.navigate("HospitalsNearMeScreen")
        })
        .catch((error)=>{
            //Handle Error here.
            var errorCode=error.code;
